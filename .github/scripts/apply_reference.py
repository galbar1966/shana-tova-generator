...
.fact-card{position:absolute;z-index:6;top:6%;right:4.4%;width:46%;max-height:29%;background:linear-gradient(270deg,rgba(255,255,255,.34) 0%,rgba(255,255,255,.22) 68%,rgba(255,255,255,.06) 100%);backdrop-filter:none;-webkit-backdrop-filter:none;border-radius:3%;padding:3.0% 3.0% 3.2%;box-shadow:none;overflow:hidden;direction:rtl;text-align:right}
...
.fact{direction:rtl;unicode-bidi:plaintext;font-family:'Rubik',Arial,sans-serif;font-size:min(2.8vw,29px);line-height:1.38;font-weight:500;white-space:normal;color:#222943;text-align:right;overflow:hidden;overflow-wrap:normal;word-break:normal;hyphens:none}
...
.brand-name{direction:ltr;color:#9847ee;font-family:'Arial Black','Rubik',Arial,sans-serif;font-size:min(5.9vw,60px);font-weight:900;letter-spacing:-2px;line-height:.95;margin-bottom:1.1%}
...
@media(max-width:680px){
 ...
 .fact-card{top:5.2vw;right:3.5vw;width:49%;max-height:44vw;border-radius:5.2vw;padding:4.2vw 3.8vw 4.3vw;background:linear-gradient(270deg,rgba(255,255,255,.30) 0%,rgba(255,255,255,.18) 66%,rgba(255,255,255,.03) 100%);box-shadow:none}
 .lead{font-size:clamp(23px,6.9vw,33px);gap:1.6vw;margin-bottom:3vw;font-weight:700}
 .fact{font-size:clamp(14px,4vw,19px);line-height:1.34;white-space:normal}
 ...
 .brand-name{font-size:clamp(38px,11vw,52px);margin-bottom:2vw;letter-spacing:-1.5px}
 .brand-line{font-size:clamp(13px,3.7vw,17px)}
 .brand-joke{font-size:clamp(11px,3vw,14px);margin-top:1.5vw}
}

@media(max-width:380px){
 .fact-card{width:50%;right:2.5vw;padding-left:3vw;padding-right:3vw}
 .lead{font-size:6.5vw}
