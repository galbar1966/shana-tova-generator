...
.punch{font-size:clamp(23px,2.75vw,31px);line-height:1.45;font-weight:700;white-space:pre-line;text-align:center;color:#202640;background:linear-gradient(135deg,#fbf8ff 0%,#f1e9fd 100%);border:0;border-radius:26px;padding:29px 34px;box-shadow:none}
...
.ending{text-align:center;color:#85899d;font-size:clamp(19px,2.2vw,25px);line-height:1.48;font-weight:700;padding:0 20px 4px}
...
.brand-name{direction:ltr;color:#9747ec;font-size:clamp(52px,5.8vw,66px);font-weight:900;letter-spacing:-1.5px;line-height:1;margin-bottom:12px}
.brand-line{font-size:clamp(18px,1.9vw,23px);line-height:1.45;font-weight:700;color:#f1eff8}
.brand-joke{font-size:clamp(14px,1.55vw,18px);line-height:1.45;margin-top:7px;color:#d4d1df}
